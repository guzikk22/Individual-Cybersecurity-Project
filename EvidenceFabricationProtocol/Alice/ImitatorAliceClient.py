...
def RepudiableAuthenticationProtocol_Alice(netSoc, My_pubKey, Their_pubKey, S, m_int, r):
	...
	# Value of m isn't randomly generated
...
##		oFile = open(oFile_ref, 'a')
	...
	if verbose:
		...
		oFile = open(oFile_ref, 'a')
	# step 12
	# r isn't calculated, agreed to value is used instead
	# r = tools.modExp(
	# 	b = c,
